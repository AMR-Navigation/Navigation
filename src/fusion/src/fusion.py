...
class Fusion:
    ...
    def updatepose(self, data):
        ...
        print("Robot Yaw")
        print("Robot Location X: ", self.x)
        print("Robot Location Y: ", self.y)
        self.frame = data.header.stamp  # sync with this probably
