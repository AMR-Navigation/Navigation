...
class MovePersonPlugin:
    ...
    def define_waypoints(self):
        self.waypoints = [
            (self.start_position.x, self.start_position.y + 4.967),  # Move to the left by approx 5 meters
            (self.start_position.x + 4.294, self.start_position.y + 4.967),  # Move up by approx 5 meters
            (self.start_position.x + 4.294, self.start_position.y + 10.5237),  # Move to the left by approx 6 meters
            (self.start_position.x + 4.294, self.start_position.y + 4.967),  # Move to the right by approx 6 meters
            (self.start_position.x, self.start_position.y + 4.967),        # Move down approx 5 meters
